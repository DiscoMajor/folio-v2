...
export default function Footer() {
    return (
        <section className={`${abel.className} text-white footer-fade footer-li xl:p-5 sm:p-5 xs:p-3 flex justify-evenly`}>
            ...
            <div>
                <ul className="flex flex-col xl:gap-2 xs:gap-0.5">
                    <h1 className="text-xl font-medium hover:text-sweetpurple">The MovieDatabase</h1>
                    <li>
            ...
            <div>
                <ul className="flex flex-col xl:gap-2 xs:gap-0.5">
                    <h1 className="text-xl font-medium  hover:text-sweetpurple">Contact Us</h1>
                    <li>
                        <Link href="#">Mail</Link>
                    </li>
                    <li>
            ...
            <div>
                <ul className="flex flex-col xl:gap-2 xs:gap-0.5">
                    <h1 className="text-xl font-medium  hover:text-sweetpurple">Legal</h1>
                    <li>
